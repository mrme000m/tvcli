...
import { registerTvCommands } from '@/commands/tv/index.js';
import { registerVisionCommands } from '@/commands/vision/index.js';
...
export const commandRegistry: CommandRegistrar[] = [
  ...
  addCommandGroup('TradingView Commands:'),
  registerTvCommands,

  addCommandGroup('Vision Commands:'),
